package com.pbl.yourside.security.sevices.jwt;

import com.pbl.yourside.security.sevices.user.UserPrinciple;
...
public class JwtProvider {
    ...
    @Value("${com.pbl.yourside.jwtSecret}")
    private  String jwtSecret;

    @Value("${com.pbl.yourside.jwtExpiration}")
